...
import com.example.intelligentdrivingassistant.find.gson.News;
import com.example.intelligentdrivingassistant.find.gson.NewsList;
import com.example.intelligentdrivingassistant.find.util.HttpUtil;
import com.example.intelligentdrivingassistant.find.util.Utility;
...
public class FindActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar)findViewById(R.id.tool_bar_find);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            Intent intent = new Intent(FindActivity.this, ContentActivity.class);
            @Override
        ...
        HttpUtil.sendOkHttpRequest(address, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FindActivity.this, "新闻加载失败", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (code == 200){
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(FindActivity.this, "数据错误返回",Toast.LENGTH_SHORT).show();
                            refreshLayout.setRefreshing(false);
                        }
                    });
                }

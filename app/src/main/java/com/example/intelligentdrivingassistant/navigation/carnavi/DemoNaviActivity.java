...
public class DemoNaviActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWgsNaviBtn = findViewById(R.id.wgsNaviBtn);//国际经纬度坐标
        mGcjNaviBtn = findViewById(R.id.gcjNaviBtn);//国测局坐标
        mBdmcNaviBtn = findViewById(R.id.bdmcNaviBtn);//百度墨卡托坐标
        mDb06ll = findViewById(R.id.mDb06llNaviBtn);//百度经纬度坐标
        mSzNaviBtn = findViewById(R.id.szNaviBtn);//导航至深圳北站
        mBjNaviBtn = findViewById(R.id.bjNaviBtn);//导航至北京天安门
        mCustomNaviBtn = findViewById(R.id.customNaviBtn);//自定义坐标点导航
